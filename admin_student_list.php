...
<body>
    ...
    <div class="search">
        <form name="search" action="admin_student_search.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
    ...
    if ($result) {
        ...
        while ($row = mysqli_fetch_array($result)) {
            ...
            <a href='admin_student_del_db.php?ID={$row[0]}' onclick=\"return confirm('Do you want to delete this record?')\" class='btn btn-danger btn-xs'> ลบ </a>
            </td>";
            echo "</tr>";
        }
