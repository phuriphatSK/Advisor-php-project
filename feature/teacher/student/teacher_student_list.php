...
<body>
    ...
    <div class="search">
        <form name="search" action="teacher_student_search.php" method="POST" enctype="multipart/form-data"
    ...
    <div class="table-group">
        ...
        $query1 = "SELECT t_id FROM teacher WHERE t_username = '$username'";
        $result1 = mysqli_query($con, $query1);
        $row1 = mysqli_fetch_array($result1);
        $t_id = $row1['t_id'] ?? null;

        if (!$t_id) {
            echo "ไม่พบข้อมูลอาจารย์ในระบบ";
            exit();
        }
