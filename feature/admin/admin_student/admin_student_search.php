...
<body>
  ...
  <h3><a class="heading" href="../admin_home.php">หน้าหลัก</a> » <a class="heading"
      href="../admin_student/admin_student_list.php">ข้อมูลนักศึกษา</a> » ค้นหานักศึกษา</h3>
  <div class="table-group">
    ...
    while ($row = mysqli_fetch_array($result)) {
      ...
      echo "<td class='edit'><a href='../admin_student/admin_student_list_edit.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs'> แก้ไข </a></td> ";
      echo "<td class='delete'><a href='../../../database/admin/admin_student_db/admin_student_del_db.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'> ลบ </a></td> ";
      echo "</tr>";
    }
    echo "</table>";
    mysqli_close($con);
