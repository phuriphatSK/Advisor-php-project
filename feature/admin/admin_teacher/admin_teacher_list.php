...
<body>
    ...
    <div class='search'>
        <form name="search" action="admin_teacher_search.php" method="POST" enctype="multipart/form-data"
    ...
    <div class="table-group">
        ...
        if ($result) {
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo "<td class='delete'><a href='../../../database/admin/admin_teacher_db/admin_teacher_del_db.php?ID={$row["t_id"]}' onclick=\"return confirm('Do you want to delete this record?')\" class='btn btn-danger btn-xs'>ลบ</a></td>";
                echo "</tr>";
            }
