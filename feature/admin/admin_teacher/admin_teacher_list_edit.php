...
<body>
  ...
  <h3><a class="heading" href="admin_home.php">หน้าหลัก</a> » <a class="heading"
      href="admin_teacher_list.php">ข้อมูลอาจารย์</a> » แก้ไขข้อมูลอาจารย์</h3>
  <div class="container">
    <div class="row">
      <form name="edit" action="../../../database/admin/admin_teacher_db/admin_teacher_list_edit_db.php"
        ...
        <div class="form-group">
          <div class="col-sm-9">
            ...
            <select name="rank" class="form-control-second" id="t_rank">
              ...
              <option value="อาจารย์" <?php if ($t_rank == 'อาจารย์') echo 'selected'; ?>> อาจารย์
              </option>
            </select>
          </div>
        </div>
          ...
          <div class="col-sm-9">
            ...
            <select name="course" class="form-control-second" id="t_course">
              <option value="วิทยาการคอมพิวเตอร์"
                <?php if ($t_course == 'วิทยาการคอมพิวเตอร์') echo 'selected'; ?>> วิทยาการคอมพิวเตอร์
              </option>
              <option value="เทคโนโลยีสารสนเทศและการสื่อสาร"
                <?php if ($t_course == 'เทคโนโลยีสารสนเทศและการสื่อสาร') echo 'selected'; ?>>
                เทคโนโลยีสารสนเทศและการสื่อสาร </option>
              <option value="คณิตศาสตร์" <?php if ($t_course == 'คณิตศาสตร์') echo 'selected'; ?>>
                คณิตศาสตร์ </option>
        ...
        <div class="form-group">
          <div class="col-sm-9">
            <p> ชื่อผู้ใช้ </p>
            <input type="text" name="t_username" class="form-control" required placeholder="username"
              value="<?php echo $t_username; ?>">
          </div>
        </div>
        <div class="btn-first">
