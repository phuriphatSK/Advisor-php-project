...
<body>
    ...
    <div class="search">
        <form name="search" action="../search/student_search.php" method="POST" enctype="multipart/form-data"
    ...
    <div class="table-group">
        ...
        if ($result) {
            ...
            while ($row) {
                ...
                echo "<td class='edit'>
            <a href='../../../database/student_db/student_list_edit.php?ID={$row[0]}' class='btn btn-warning btn-xs'> แก้ไข </a>
            </td>";
                echo "<td class='delete'>
            <a href='../../../database/student_db/student_del_db.php?ID={$row[0]}' onclick=\"return confirm('Do you want to delete this record?')\" class='btn btn-danger btn-xs'> ลบ </a>
            </td>";
                echo "</tr>";
            }
