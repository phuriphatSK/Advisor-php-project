...
<body>
    <div class="table-group">
        ...
        while($row = mysqli_fetch_array($result)) {
            ...
            echo "<td><a href='../edit/student_edit.php?act=edit&ID=$row[0]' class='btn btn-warning btn-xs'> แก้ไข </a></td> ";
            echo "<td><a href='../../../database/student_db/student_del_db.php?ID=$row[0]' onclick=\"return confirm('Do you want to delete this record? !!!')\" class='btn btn-danger btn-xs'> ลบ </a></td> ";
            echo "</tr>";
        }
        echo "</table>";
        mysqli_close($con);
