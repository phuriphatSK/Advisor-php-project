...
<body>
    <?php
      include('navbar.php');
    ?>
    <h3><a class="heading" href="teacher_home.php">หน้าหลัก</a> »<a class="heading" href="teacher_info.php">ข้อมูลส่วนตัว</a> » แก้ไขข้อมูลส่วนตัว</h3>
    <?php
        include('condb.php');
        $id = $_REQUEST["ID"];
    ...
    <div class="container">
        <div class="row">
            ...
            <input type="hidden" name="id" value="<?php echo $id; ?>" />
                    ...
                    <a href="teacher_info.php" class="btn btn-cancel">ยกเลิก</a>
            </form> 
        </div>
  </div>
</body>
